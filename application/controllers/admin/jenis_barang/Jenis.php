...
class Jenis extends CI_Controller {
	...
	{
		$isi['content']		= 'admin/jenis_barang/jenis_barang';
	...
	{
		$isi['content']		= 'admin/jenis_barang/jenis_tambah';
	...
	{
		$isi['content']		= 'admin/jenis_barang/jenis_update';
		$isi['judul']		= 'Manajemen data';
...
;		$isi['kt']			= $this->Jenis_model->get_ktgori();
	...
	public function simpan() {
		...
		?>
          ...
          <script type="text/javascript">alert("Tambah data barang berhasil."); window.location.href="<?php echo base_url();?>admin/jenis_barang/jenis"</script> <?php
	}
	...
	public function hapus($id_barang)
	{
		...
		?>
			<!-- muncul peringatan kalau login gagal dan langsung kembali ke halaman login.php-->
          <script type="text/javascript">alert("hapus data barang berhasil."); window.location.href="<?php echo base_url();?>admin/jenis_barang/jenis"</script> <?php
	}
	...
	?>
			<!-- muncul peringatan kalau login gagal dan langsung kembali ke halaman login.php-->
          <script type="text/javascript">alert("Update data barang berhasil."); window.location.href="<?php echo base_url();?>admin/jenis_barang/jenis"</script> <?php
}
