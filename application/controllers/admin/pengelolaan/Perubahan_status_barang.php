...
class Perubahan_status_barang extends CI_Controller {

	public function __construct()
	{
		parent::__construct();		
		$this->load->model('Model_perubahan');
	...
	{
		$isi['content']		= 'admin/kampus/kampus_data';
		$isi['judul']		= 'Manajemen data';
		$isi['sub_judul']	= 'Data Barang';
		$isi['data'] 		= $this->db->get('a_tblkampus');
