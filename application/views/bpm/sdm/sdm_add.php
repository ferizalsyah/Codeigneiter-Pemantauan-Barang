<div class="box box-primary">
  <div class="box-header">
    ...
    <!-- /.box-header -->
    <div class="box-body">
    <form class="form-horizontal" method="post" action="<?php echo base_url();?>/bpm/sdm/sdm/simpan" enctype="multipart/form-data">
			<div class="box-body">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tempat_lahir" class="form-control" id="inputPassword3">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tgl_lahir" class="form-control" id="reservation">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>bpm/lokasi_ruang/ruang_lokasi" class="btn btn-danger btn-sm">Batal</a> &nbsp;&nbsp;
